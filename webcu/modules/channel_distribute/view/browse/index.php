<?php
	...
	$query = 'SELECT * FROM `channel_distribute_category` where `lang`= "'.$current_lang.'" and id = "'.getParam('category_id', 'id', 0).'"';
...
<div class="tdr">
	...
	<a href="<?php echo generate_url('channel_distribute') ?>"><?php echo _CHANNEL_DISTRIBUTE ?></a><?php if($category_current) echo ' &raquo; '.$category_current['title'];?>
	</div></div>
