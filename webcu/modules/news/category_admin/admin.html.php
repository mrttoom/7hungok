	...
	?>
		<script >
			...
			{	
				...
				if (res) 
				{
					document.location.href= "<?php echo generate_url('news_category_admin', array('task'=>'delete', 'curPg')); ?>&value="+value;
				}
			}
			...
			{	
				...
				document.location.href= "<?php echo generate_url('news_category_admin', array('task'=>'edit', 'curPg')); ?>&id="+value;
			}
						...
						<table id="toolbar" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr align="center" valign="middle">
									<td>
										<a class="toolbar" href="<?php echo generate_url('news_category_admin', array('task'=>'add', 'curPg')); ?>">
		...
		<div class="centermain" align="center">
			<div class="main">
				<table class="adminheading">
					<tbody>
						<tr>
							<th><?php echo _NEWS_CATEGORY_ADMIN;?></th>
						</tr>
					</tbody>
				</table>
				...
				if($rows)
				{
					...
					foreach($rows as $row)
					{
						...
						<tr class="<?php echo $class_row; ?>" valign="top">
							...
							<td><?php echo $i; ?></td>
							<td>
								<a href="<?php echo generate_url('news_category_admin', array('task'=>'edit', 'id'=>$row['id'])); ?>"><?php echo $row['title']; ?></a>
							</td>
							<td>
								<?php echo $row['lang']; ?>
							</td>
						...
						<table id="toolbar" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr align="center" valign="middle">
									...
									<td>&nbsp;</td>
									<td>
										<a class="toolbar" href="<?php echo generate_url('news_category_admin'); ?>">
											<img src="<?php echo SITE_PATH;?>themes/images/cancel.png" alt="<?php echo _CANCEL;?>" name="<?php echo _CANCEL;?>" title="<?php echo _CANCEL;?>" align="middle" border="0">
											<br /><?php echo _CANCEL;?>
										</a>
									</td>
			...
			<div class="main">
				<table class="adminheading">
					<tbody>
						<tr>
							<th>
								<?php echo _NEWS_CATEGORY_ADMIN;?>: <small><?php echo _UPDATE_NEWS_CATEGORY;?></small>
							</th>
						</tr>
					</tbody>
				</table>
				<table class="adminform">
					<tbody>
						<tr>
							<th colspan="2">
								<?php echo _UPDATE_NEWS_CATEGORY;?>
							</th>
						</tr>
						<tr>
							<td width="130px">
