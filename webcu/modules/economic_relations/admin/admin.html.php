	...
	?>
		<script >
			...
			{	
				...
				if (res) 
				{
					document.location.href= "<?php echo generate_url('economic_relations_admin', array('task'=>'delete', 'curPg')); ?>&value="+value;
				}
			}
			...
			{	
				...
				if (res) 
				{
					document.location.href= "<?php echo generate_url('economic_relations_admin', array('task'=>'delete_image', 'curPg')); ?>&value="+value;
				}
			}
			function editNews()
			{	
				...
				document.location.href= "<?php echo generate_url('economic_relations_admin', array('task'=>'edit', 'curPg')); ?>&id="+value;
			}
						...
						<table id="toolbar" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr align="center" valign="middle">
									<td>
										<a class="toolbar" href="<?php echo generate_url('economic_relations_admin', array('task'=>'add', 'curPg')); ?>">
		...
		<div class="centermain" align="center">
			<div class="main">
				<table class="adminheading">
					<tbody>
						<tr>
							<th><?php echo _ECONOMIC_RELATIONS_ADMIN;?></th>
						</tr>
					</tbody>
				</table>
					...
					<tbody>
						<tr>
							...
							<th class="title" width="20%">
								<?php echo _ECONOMIC_RELATIONS_CATEGORY;?>: <select name="category_id" onchange="this.form.submit()"><?php echo get_option($news_category_arr, getParam('category_id', 'int', 0)); ?></select>
							</th>
				...
				if($rows)
				{
					...
					foreach($rows as $row)
					{
						...
						<tr class="<?php echo $class_row; ?>" valign="top">
							...
							<td><?php echo $i; ?></td>
							<td>
								<a href="<?php echo generate_url('economic_relations_admin', array('task'=>'edit', 'id'=>$row['id'])); ?>"><?php echo $row['title']; ?></a>
								<br />
							...
							<td>
								<?php
									$image_file = get_image($row, 'small', 'economic_relations');
									if($image_file)
						...
						<table id="toolbar" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr align="center" valign="middle">
									...
									<td>&nbsp;</td>
									<td>
										<a class="toolbar" href="<?php echo generate_url('economic_relations_admin'); ?>">
											<img src="<?php echo SITE_PATH;?>themes/images/cancel.png" alt="<?php echo _CANCEL;?>" name="<?php echo _CANCEL;?>" title="<?php echo _CANCEL;?>" align="middle" border="0">
											<br /><?php echo _CANCEL;?>
										</a>
									</td>
			...
			<div class="main">
				<table class="adminheading">
					<tbody>
						<tr>
							<th>
								<?php echo _ECONOMIC_RELATIONS_ADMIN;?>: <small><?php echo _UPDATE_ECONOMIC_RELATIONS;?></small>
							</th>
						</tr>
					</tbody>
				</table>
				<table class="adminform">
					<tbody>
						<tr>
							<th colspan="2">
								<?php echo _UPDATE_ECONOMIC_RELATIONS;?>
							</th>
						</tr>
						<tr>
							<td>
								<?php echo _ECONOMIC_RELATIONS_CATEGORY;?>
							</td>
							<td colspan="2">	
