<?php
	...
	$query = 'SELECT * FROM `economic_relations_category` where `lang`= "'.$current_lang.'" and id = "'.getParam('category_id', 'id', 0).'"';
...
<div class="tdr">
	...
	<a href="<?php echo generate_url('economic_relations') ?>"><?php echo _ECONOMIC_RELATIONS ?></a><?php if($category_current) echo ' &raquo; '.$category_current['title'];?>
	</div></div>
