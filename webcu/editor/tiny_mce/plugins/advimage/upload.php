...
<head>
	...
	{
		window.open("/hanam/?module=upload_image", "window","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=300,height=200");
	}
	</script>
</head>
							...
							<tr>
								...
								<td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
									<tr> 
									  ...
									  <td>&nbsp;&nbsp;<a href="#" onClick="OpenUploadFile();">Upload</a></td>
									</tr>
								  </table></td>
							</tr>
